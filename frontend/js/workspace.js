    ...
    <div class="workspace-grid">
      <section class="document-area" aria-labelledby="document-title"><div class="panel-heading"><div><p class="eyebrow">YOUR DOCUMENT</p><h2 id="document-title">Start with a PDF</h2></div><span id="document-tag" class="workspace-label">No document</span></div>
        ...
        <div id="review-view" hidden>
          <div class="sample-toolbar"><span id="page-label">Page 1</span><span class="page-nav"><button id="review-cancel" class="text-button" type="button">Discard document</button><button id="prev-page" class="text-button" type="button">← Previous</button><button id="next-page" class="text-button" type="button">Next →</button></span></div>
